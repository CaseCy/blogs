...
```
### ENV 和 ARG区别
参考：<http://scmroad.com/topics/39188>
...
- `WORKDIR /path/to/workdir`
  ...
  Dockerfile还有一些其他的指令，例如STOPSINGAL、HEALTHCHECK、SHELL等。由于并不是很常用，本书不作赘述。有兴趣的读者可前往<https://docs.docker.com/engine/reference/builder/> 扩展阅读。
...
- 例子参考
  <http://blog.51cto.com/zero01/2069879>
  <https://blog.csdn.net/qq_34409701/article/details/79949401>